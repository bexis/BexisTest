...
async function createEventTest(skipped) {
  ...
  it(`should show an error message when ${skipped} is missing`, async () => {
    ...
    await assert.isFulfilled(page.type('#MailInformation', 'event.test.addInfo'), 'should enter an additional mail information');
    ...
    if (!('eventLanguage' == skipped)) {
      ...
      await assert.isFulfilled(page.select('#SelectedEventLanguage', selectLang), 'should select a random event language');
    }
    ...
    await assert.isFulfilled(page.type('#EmailCC', Config.emmEmails.emails.primaryEmail), 'should enter a CC email address');
    ...
    await assert.isFulfilled(page.type('#EmailBCC', Config.emmEmails.emails.secondaryEmail), 'should enter a BCC email address');
    ...
    await assert.isFulfilled(page.type('#EmailReply', Config.emmEmails.emails.primaryEmail), 'should enter a mail address');
